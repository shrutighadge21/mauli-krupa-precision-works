...
# At p=0, each component sits at (vx, vy) in its assembled state.
# At p=1, each component sits at (0, 0) in its exploded state.
components = {
    'top_bridge': {
        'offset': (0, 140),
        'start_p': 0.05,
...
for i in range(TOTAL_FRAMES):
    ...
    cad_line_color = (197, 34, 39, 140) # Engineering accent color with smooth transparency
...
print(f"SUCCESS: Generated {TOTAL_FRAMES} authentic CAD engineering blueprint exploded frames!")
