...
import { Phone, Mail, MapPin, ArrowRight, CheckCircle2, ShieldCheck, Clock, Send, ChevronRight, Crosshair } from 'lucide-react';
      ...
      <div className="container-custom" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ maxWidth: '820px', marginBottom: '52px' }}>
          <div className="eyebrow-label" style={{ marginBottom: '12px' }}>
            ...
            <span>START A PRECISION ENGINEERING PROJECT</span>
          </div>
          ...
          >
            Discuss your manufacturing requirements, send 2D/3D CAD drawings, or request technical quotations for custom jigs, fixtures, conveyors, SPMs, and heavy fabrication.
          </p>
        </div>
        ...
        >
          {/* ===================================================================== */}
          {/* LEFT COLUMN: DIRECT ENGINEERING CONTACTS & WORKS FACILITY             */}
          {/* ===================================================================== */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{ borderBottom: '1px solid #f1f3f5', paddingBottom: '24px' }}>
              ...
              >
                ...
                <span>DIRECT TECHNICAL CONTACTS</span>
              </div>

              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
                  <div>
                    <div style={{ fontSize: '15px', fontWeight: 700, color: '#111827' }}>Abhishek Marotkar</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
                  <div>
                    <div style={{ fontSize: '15px', fontWeight: 700, color: '#111827' }}>Santos Marotkar</div>
            ...
            <div style={{ borderBottom: '1px solid #f1f3f5', paddingBottom: '24px' }}>
              ...
              >
                <Crosshair size={12} color="#c52227" />
                <span>WORKS & OFFICE LOCATION</span>
              </div>
          ...
          {/* ===================================================================== */}
          {/* RIGHT COLUMN: REFINED INDUSTRIAL ENQUIRY FORM                         */}
          {/* ===================================================================== */}
          <div
            style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                ...
                <div style={{ marginBottom: '4px' }}>
                  ...
                  <p style={{ fontSize: '13px', color: '#64748b', margin: 0 }}>
                    Please fill in your details below. All technical inquiries and drawings are handled with strict confidentiality.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Briefly describe your tooling, fixture, conveyor, automation system or fabrication requirement."
                    style={{
                      width: '100%',
                      padding: '12px 14px',
                      fontSize: '14px',
